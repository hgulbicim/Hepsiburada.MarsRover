    ...
    public class RoverServiceTestTheoryData : TheoryData<RoverServiceTestParameter>
    {
        public RoverServiceTestTheoryData()
        {
            Add(new RoverServiceTestParameter
            {
                ...
                Expected = new RoverPosition { X = 1, Y = 3, CurrentDirectionType = DirectionType.North }
            });
            ...
            Add(new RoverServiceTestParameter
            {
                ...
                Expected = new RoverPosition { X = 5, Y = 1, CurrentDirectionType = DirectionType.East }
            });
        }

        public static IEnumerable<object[]> IsThereAnyRoverOnThePosition
        {
            get
            {
                yield return new object[] { new InputModel{
                                            RoverList = new List<Rover> {
                                                new Rover {
                                                    RoverPosition = new RoverPosition{
                                                        X = 1,
